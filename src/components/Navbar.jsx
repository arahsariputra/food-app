...
export const Navbar = () => {
  ...
  return (
    <div class='max-w-[1640px] mx-auto flex justify-between 
    items-center p-4'>
        {/* Left side */}
        <div className='flex items-center'>
            ...
            <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-l text-[14]'>
        ...
        {nav ? <div className='bg-black/80 fixed w-full h-screen z-10 top-0 left-0'></div> : ''}
            ...
            {/* Side Drawer Menu */}
            <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screan bg-white z-10 duration-300' : 
            'fixed top-0 left-[-100%] w-[300px] h-screan bg-white z-10 duration-300'}>
                <AiOutlineClose
                onClick={() => setNav(!nav)}
            ...
            <nav>
                <ul className='flex flex-col p-4 text-gray-800'>
                    ...
                    <li className='text-xl py-4 flex'><BsFillSave2Fill size={25} className='mr-4'/>Best Ones</li>
