...
const Food = () => {
  ...
  return (
    <div className='max-w-[1640] m-auto px-4 py-12'>
        ...
        <div className='flex flex-col lg:flex-row justify-between'>
            ...
            <div>
                ...
                <div className='flex justify-between flex-wrap'>
                    ...
                    <button onClick={()=> filterType('chiken')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>Chiken</button>
                </div>
            </div>
            {/* Filter Price */}
            <div>
        ...
        {/* Display foods */}
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 pt-48'>
